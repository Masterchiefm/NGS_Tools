...
class Ui_BCL2Fastq(object):
    def setupUi(self, BCL2Fastq):
        ...
        self.frame_requirement = QtWidgets.QFrame(self.groupBox_2)
        self.frame_requirement.setFrameShape(QtWidgets.QFrame.StyledPanel)
        self.frame_requirement.setFrameShadow(QtWidgets.QFrame.Raised)
        self.frame_requirement.setObjectName("frame_requirement")
        self.verticalLayout_4 = QtWidgets.QVBoxLayout(self.frame_requirement)
        self.verticalLayout_4.setObjectName("verticalLayout_4")
        self.label_3 = QtWidgets.QLabel(self.frame_requirement)
        self.label_3.setObjectName("label_3")
        self.verticalLayout_4.addWidget(self.label_3)
        self.label_version = QtWidgets.QLabel(self.frame_requirement)
        self.label_version.setObjectName("label_version")
        self.verticalLayout_4.addWidget(self.label_version)
        self.pushButton_install_bcl2fq = QtWidgets.QPushButton(self.frame_requirement)
        ...
        self.verticalLayout.addWidget(self.frame_requirement)
